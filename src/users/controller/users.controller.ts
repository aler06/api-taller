...
export class UsersController {
  ...
  @ApiOperation({
    ...
    description:
      'Creates a new user account with the provided information. Only administrators can create users. The user will be created in inactive state by default.',
  })
  @ApiBody({
    type: UserRequestDTO,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves a list of all users in the system. Only administrators can access this endpoint. Passwords are excluded from the response.',
  })
  @ApiOkResponse({
    type: [UserResponseDTO],
  ...
  @ApiOperation({
    ...
    description:
      'Searches users by first name, last name, email, or role. Only administrators can access this endpoint. Search is case-insensitive.',
  })
  @ApiQuery({
    name: 'q',
  ...
  @ApiOperation({
    ...
    description:
      'Retrieves users with pagination support. Only administrators can access this endpoint. Returns users with total count and pagination metadata.',
  })
  @ApiQuery({
    name: 'page',
  ...
  @ApiOperation({
    summary: 'Update user',
    description:
      'Updates an existing user with the provided information. Only provided fields will be updated.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    summary: 'Delete user',
    description:
      'Permanently deletes a user from the system. Only administrators can perform this action.',
  })
  @ApiParam({
    name: 'id',
