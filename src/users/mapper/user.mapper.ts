...
export class UserMapper {
     ...
     */
    static toUserModelForUpdate(userRequestDTO: Partial<UserRequestDTO>): Partial<User> {
     ...
     */
    static extractPasswordForUpdate(userRequestDTO: Partial<UserRequestDTO>): string | undefined {
        return userRequestDTO.password;
    }
